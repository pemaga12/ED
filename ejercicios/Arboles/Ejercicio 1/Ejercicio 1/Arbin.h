   ...
   public:	  
	  ...
	  */
	  int numNodos(const Arbin& a) {
		  int contador = 0;
		  if (_ra->_iz == NULL && _ra->_dr == NULL) {
			  return 1;			//la raíz no tiene hijos y devuelve 1
		  }
		  else {
			  if (_ra->_dr != NULL)
			  contador = cuentaNodosAux(a.hijoDer(), contador + 1);
			  else if (_ra->_iz != NULL)
			  contador = cuentaNodosAux(a.hijoIz(), contador + 1);
		  }
	  }

	  int cuentaNodosAux(const Arbin& a, int contador) {
		  if (_ra->_dr != NULL)
			  contador = cuentaNodosAux(a.hijoDer(), contador + 1);
		  else if (_ra->_iz != NULL)
			  contador = cuentaNodosAux(a.hijoIz(), contador + 1);
	  ...
	  */
	  ...
	  int talla(const Arbin& a) {

	  }

	  /*
	  Devuelve una lista von todas las hojas del árbol de izquierda a derecha
	  

	  Lista<Nodo> frontera(const Arbin& a) {
	  ...
	  */
	  ...
	  /*
	  Devuelve el elemento más pequeño de todos los almacenados en el árbol.
	  */
